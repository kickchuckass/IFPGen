...
from models.molopt_score_model import IFPDiff, log_sample_categorical
...
def sample_diffusion_ligand(model, data, num_samples, batch_size=16, device='cuda:0',
                            ...
                            energy_drift_opt = None, full_protein_pos=None,
                            ):
    ...
    current_i = 0
    for i in tqdm(range(num_batch), miniters=500,  ncols = 10):
        ...
        with torch.no_grad():
            ...
            r = model.sample_diffusion(
                ...
                # -----shape------
                refer_ligand_pos = batch.ligand_pos,
                refer_ligand_v = batch.ligand_atom_feature_full,
                refer_ligand_batch = batch.ligand_element_batch,

                unimol_repr = getattr(batch, 'unimol_repr', None)
            )
